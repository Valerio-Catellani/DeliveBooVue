              ...
              <table class="table text-center">
                ...
                <tbody>
                  <tr v-for="(item, index) in store.cart.dishes" :key="index">
                    <td class="image-container w-100"><img :src="item.img" alt="Immagine del piatto" class="cart-image" style="width: 50%;"></td>
                    <td>{{ item.nome }}</td>
                    <td>€ {{ item.prezzo }}</td>
                    <td>{{ item.qty }}</td>
                  </tr>
        ...
        <div class="col-md-6 pt-3">
          ...
          <form id="payment-form" @submit.prevent="submitPayment">
            <div class="form-group mt-4">
              ...
              <input class="form-control" type="text" id="name" v-model="name" required minlength="3" maxlength="255">
            </div>
            <div class="form-group">
              <label for="lastname">Cognome*</label>
              <input class="form-control" type="text" id="lastname" v-model="lastname" required minlength="3" maxlength="255">
            </div>
            <div class="form-group">
              <label for="email">Email*</label>
              <input class="form-control" type="email" id="email" v-model="email" required minlength="3" maxlength="255">
            </div>
            <div class="form-group">
              <label for="address">Indirizzo*</label>
              <input class="form-control" type="text" id="address" v-model="address" required minlength="3" maxlength="255">
            </div>
            <div class="form-group">
