            ...
            <div class="main w-75 d-flex flex-column">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="50%"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <path fill="none" d="M0 0H1366V800H0z" transform="translate(-448 -157)" />
                        <g transform="translate(-448 -157) translate(448 157)">
                            <mask id="prefix__b" fill="none">
                                <use xlink:href="#prefix__a" />
                            </mask>
                            <use fill="#C5C5C5" xlink:href="#prefix__a" />
                ...
                <h2 class="display-2 fw-bold text-center pt-5 title-primary fst-italic">La Pagina che stai cercando non
                    esiste</h2>
            </div>
        </section>
    </div>
